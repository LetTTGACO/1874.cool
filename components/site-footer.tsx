            ...
            <div className="flex flex-wrap items-center justify-center md:justify-between">
                <div className="w-full px-4 ">
                  <div className="mb-2 flex justify-between text-center md:mb-0 md:text-left">
                    <a href="https://1874.cool" target="_blank" className="text-blueGray-500 py-1 text-center text-sm font-semibold md:text-left" rel="noreferrer">Copyright © 2026 1874</a>
